...
public final class RESTClient {
	...
	public void registerClientApplication() throws Exception {
		...
		rs.form(new Form().param("appName", "Restaurant Reservations").param("appURI", "http://localhost:" + port + "/services/reservations/reserve").param("appRedirectURI", "http://localhost:" + port + "/services/reservations/reserve/complete"));
	}
